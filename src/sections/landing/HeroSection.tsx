    ...
    return(
        <section id="hero" className="w-full pb-24">
            ...
            <div className="col-span-12 lg:col-span-6 mt-12 xl:mt-10 space-y-4 sm:space-y-6 px-6 text-center sm:text-left">
                ...
                >
                Ahora con{" "}
                <span className="text-header-gradient">Nosotros Solucionamos</span>{" "}<br></br>
                <TypedComponent type={1}/>
                </h1>
                <p
                data-aos="fade-down"
                data-aos-once="true"
                ...
                Accede a nuestros servicios desde 40.000 COP por mes.
                </p>
                <div
                data-aos="fade-up"
                data-aos-once="true"
                ...
                >
                <BaseButton onClick={openModal} style="max-w-full px-8 py-4 bg-gradient-to-r from-[#468ef9] to-[#0c66ee] border border-[#0c66ee] text-white">
                    Empezar ya!
                </BaseButton>
                <BaseButton onClick={openWP} style="max-w-full px-6 py-4 bg-inherit text-gradient border border-[#0c66ee] flex items-center justify-center">
